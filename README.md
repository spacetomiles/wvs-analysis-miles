...
![Feature Importance Plot](feature_importance_plot.svg)
...
A detailed table of coefficients is available in `regression_coefficients.csv`.
...
| **Q46** (Happiness) | 0.54 | 1.72 | **Recoded**: Higher = Happier. Strong positive predictor. |
| **Q47** (Health) | 0.13 | 1.14 | **Recoded**: Higher = Healthier. Positive predictor. |
...
![Binary ROC Curve](roc_curve_ordinal_binary.svg)
